...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('winter', models.CharField(blank=True, choices=[('н/к', 'некатегорийный'), ('1А', '1А'), ('1Б', '1Б'), ('2А', '2А'), ('2А', '2Б'), ('3А', '3А'), ('3Б', '3Б')], max_length=20, verbose_name='Зима')),
                ('summer', models.CharField(blank=True, choices=[('н/к', 'некатегорийный'), ('1А', '1А'), ('1Б', '1Б'), ('2А', '2А'), ('2А', '2Б'), ('3А', '3А'), ('3Б', '3Б')], max_length=20, verbose_name='Лето')),
                ('autumn', models.CharField(blank=True, choices=[('н/к', 'некатегорийный'), ('1А', '1А'), ('1Б', '1Б'), ('2А', '2А'), ('2А', '2Б'), ('3А', '3А'), ('3Б', '3Б')], max_length=20, verbose_name='Осень')),
                ('spring', models.CharField(blank=True, choices=[('н/к', 'некатегорийный'), ('1А', '1А'), ('1Б', '1Б'), ('2А', '2А'), ('2А', '2Б'), ('3А', '3А'), ('3Б', '3Б')], max_length=20, verbose_name='Весна')),
            ],
            options={
